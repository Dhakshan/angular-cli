  ...
  self(){
    ...
    cs.fn("signupModal",function(){
      var obj = {
            ...
            form: new ControlGroup({
                name: new Control("", Validators.compose([fv.isRequired])),
                email: new Control("", Validators.compose([fv.isEmailFormat, fv.isRequired])),
                mobile: new Control("", Validators.compose([fv.isRequired, fv.mobilePhone])),
                password: new Control("", Validators.compose([fv.passwordStrength, fv.isRequired])),
                captcha: new Control("", Validators.compose([fv.isRequired])),
                iagree: new Control("", Validators.compose([fv.isRequired]))
            })
        };
    ...
    cs.fn("forgotPasswordModal",function(){
        var obj = {
            ...
            form: new ControlGroup({
                email: new Control("", fv.isDummy),
                mobile: new Control("", fv.isDummy),
            }),
            formSuccess: {
                msg: "",
    ...
    cs.fn("mobileVerificationModal",function(){
        var obj = {
            ...
            form: new ControlGroup({
                otp: new Control("", Validators.compose([fv.isRequired, fv.isNumber])),
            }),
            formSuccess: {
    ...
    cs.fn("resetPasswordModal",function(){
        var obj = {
            ...
            form: new ControlGroup({
                password: new Control("", Validators.compose([fv.passwordStrength, fv.isRequired])),
                confirmpassword: new Control("", Validators.compose([fv.isRequired])),
            }),
            formSuccess: {
    ...
    cs.fn("referAFriendModal",function(){
        var obj = {
            ...
            form: new ControlGroup({
                friendname: new Control("", Validators.compose([fv.isRequired])),
                friendemail: new Control("", Validators.compose([fv.isEmailFormat, fv.isRequired])),
                friendmobileno: new Control("", Validators.compose([fv.isRequired, fv.mobilePhone]))
            }),
            formSuccess: {
    ...
    cs.fn("referAOwnerModal",function(){
        var obj = {
            ...
            title: "Refer A Owner",
            form: new ControlGroup({
                honame: new Control("", Validators.compose([fv.isRequired])),
                hoemail: new Control("", Validators.compose([fv.isEmailFormat])),
                homobileno: new Control("", Validators.compose([fv.isRequired, fv.mobilePhone])),
                hoaddress: new Control("", Validators.compose([fv.isRequired, fv.isAddress])),
                hocity: new Control("", Validators.compose([fv.isRequired, fv.isAddress])),
                hopincode: new Control("", Validators.compose([fv.isPincode, fv.isRequired]))
            }),
            formSuccess: {
    ...
    cs.fn("suggestLocationModal",function(){
        var obj = {
            ...
            form: new ControlGroup({
                location: new Control("", Validators.compose([fv.isRequired, fv.isAddress])),
                name: new Control("", Validators.compose([fv.isRequired])),
                email: new Control("", Validators.compose([fv.isEmailFormat, fv.isRequired])),
                mobileno: new Control("", Validators.compose([fv.isRequired, fv.mobilePhone]))
            }),
            formSuccess: {
